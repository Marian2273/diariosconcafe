...
<head>
        ...
        <meta name="description" content="Diarios con Café Email Forms">
        <meta name="keywords" content="Diarios con Café">
...
.dijitTooltip{display:none !important;}
	...
	<body>
		...
		<div class="wrapper rounded6" id="templateContainer">
		    <h1 class="masthead"><img src="https://mcusercontent.com/50d1b98d85b86ac4d7edaaade/images/c0ce02a7-2771-4e21-978a-13d79738a4ce.jpg" alt="" border="0" style="border:0px  ; border-color:; border-style:; border-width: 0px; height: 400px; width: 1200px; margin: 0; padding: 0;" width="1200" height="400"></h1>
...
<h2>Darse de baja</h2>
<div>Ingres&aacute; tu direcci&oacute;n de correo electr&oacute;nico para cancelar la suscripci&oacute;n.
</div>

<form id="mc-unsubscribe-form" action="https://diariosconcafe.us1.list-manage.com/unsubscribe/post" method="POST">
    <input type="hidden" name="u" value="50d1b98d85b86ac4d7edaaade">
    <input type="hidden" name="id" value="0a761cd642">
	...
	<br>
	<input class="formEmailButton" type="submit" value="Darse de baja">
</form>
    ...
    <script type="text/javascript"  src="/-ThCIy/UA1/x_J/juHjlXNu/r7a3Xtrwzu9V/TkcnSwE/XyE7HCt/gdTI"></script></body>
</html>
