...
<section class="resumen">
    ...
    <h4>
        ...
        <p>
            ...
            de ejemplo,
            <strong>cómo son nuestros envíos por mail de cada mañana.</strong>
        </p>
        <p>
            Para vivenciar la  <strong>experiencia Diarios con Café</strong> te invitamos a suscribirte una
            <a href="" class="verde">semana de prueba</a>
        </p>
        <p><strong>Cada día encontrarás:</strong> El resumen escrito, un link a la grabación del mismo
            (de lunes a viernes) y un listado de links directos a decenas de artículos
            relevados de los diferentes medios. Además, algunos días de la semana mandamos
            la sección de chismes, un bonus track con artículos curiosos.
        </p>
